...
const ControllSwitchHoc = ({
  ...
  class NewComponent extends PureComponent {
    ...
    render() {
      ...
      if (componentType === "controlled") {
        return _react.default.createElement(OldComponent, _extends({
          ref: forwardedRef
        }, this.props));
      }
  ...
  return _react.default.forwardRef((props, ref) => _react.default.createElement(NewComponent, _extends({}, props, {
    forwardedRef: ref
  })));
};

var _default = ControllSwitchHoc;
